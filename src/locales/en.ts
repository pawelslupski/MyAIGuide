const en = {
  ...
  tripView: {
    ...
    saveErrors: {
      UNAUTHORIZED: 'Your session has expired. Please log in again and try once more.',
      NOT_FOUND: 'This trip no longer exists or has been deleted.',
      FORBIDDEN: 'You do not have permission to edit this trip.',
      VALIDATION_ERROR: 'Some fields contain invalid values. Check the form and try again.',
      generic: 'An error occurred while saving. Check your connection and try again.'
    },
  ...
  tripEditor: {
    ...
    durationHint: 'Max. 14 days',
    durationError: 'Number of days must be between 1 and {max}',
    peopleLabel: 'Number of People',
    peoplePlaceholder: 'e.g. 2',
    peopleHint: 'Max. 30 people',
    peopleError: 'Number of people must be between 1 and {max}',
  ...
  plan: {
    ...
    fixNumDays: 'Fix the number of days — must be between 1 and 14',
    fixNumPeople: 'Fix the number of people — must be between 1 and 30',
    ...
    patienceDesc:
      'Plan generation is in progress. Generation time depends mainly on the number of days — a short trip takes a few tens of seconds, while a 10–14 day plan can take up to 2–3 minutes. Please do not close this page.',
    featureDisabled: 'Plan generation is not available in the current environment.',
