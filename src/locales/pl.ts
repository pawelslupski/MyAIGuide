...
const pl: MessageSchema = {
  ...
  tripView: {
    ...
    saveErrors: {
      UNAUTHORIZED: 'Twoja sesja wygasła. Zaloguj się ponownie i spróbuj jeszcze raz.',
      NOT_FOUND: 'Ta podróż nie istnieje lub została usunięta.',
      FORBIDDEN: 'Nie masz uprawnień do edycji tej podróży.',
      VALIDATION_ERROR: 'Dane są nieprawidłowe. Sprawdź pola formularza i spróbuj ponownie.',
      generic: 'Wystąpił błąd podczas zapisywania. Sprawdź połączenie i spróbuj ponownie.'
    },
  ...
  tripEditor: {
    ...
    durationHint: 'Maks. 14 dni',
    durationError: 'Liczba dni musi wynosić od 1 do {max}',
    peopleLabel: 'Liczba osób',
    peoplePlaceholder: 'np. 2',
    peopleHint: 'Maks. 30 osób',
    peopleError: 'Liczba osób musi wynosić od 1 do {max}',
  ...
  plan: {
    ...
    fixNumDays: 'Popraw liczbę dni — musi wynosić od 1 do 14',
    fixNumPeople: 'Popraw liczbę osób — musi wynosić od 1 do 30',
    ...
    patienceDesc:
      'Trwa generowanie planu. Czas generowania zależy głównie od liczby dni — krótki wyjazd zajmuje kilkadziesiąt sekund, plan na 10–14 dni może potrwać nawet 2–3 minuty. Nie zamykaj strony.',
    featureDisabled: 'Generowanie planu nie jest dostępne w bieżącym środowisku.',
